package dev.gaphunter.phpcomposerscriptcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.phpcomposerscriptcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.phpcomposerscriptcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "PHP Composer Script Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33792-php-composer-script-companion/reviews"
